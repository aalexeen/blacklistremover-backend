...
import org.bhmc.blacklistremover.error.AppException;
import org.bhmc.blacklistremover.error.ErrorType;
...
import static org.bhmc.blacklistremover.error.ErrorType.*;
...
// more specific first
    ...
    ProblemDetail processException(@NonNull Throwable ex, HttpServletRequest request, Map<String, Object> additionalParams) {
        ...
        if (optType.isPresent()) {
            ...
            return createProblemDetail(ex, path, APP_ERROR, "Exception " + ex.getClass().getSimpleName(), additionalParams);
        }
    }
